...
<div id="content" class="clearfix">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8">
				<?php $this->load->view('common/new_status'); ?>
				<div id="status-container">
					<?php if (!is_null($news_feed)) { 
						...
						$this->load->view('common/no_status');
					} ?>
				</div>
			</div>
			<?php $this->load->view('common/timeline_nav') ?>
		</div>
		<br><br>
...
<?php $this->load->view("common/delete_status_modal"); ?>
	...
	*/
    ...
    function get_more_news_feed(){
     	if (!hetroi) 
     	{
		  	$.ajax({
				type : "post",
				url  : "<?php echo site_url('get_more_news_feed'); ?>",
